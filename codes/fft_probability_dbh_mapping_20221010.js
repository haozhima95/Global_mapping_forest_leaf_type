...
// Map.addLayer(comp.select(['CHELSA_Precipitation_of_Warmest_Quarter']));
...
// var ds = ee.FeatureCollection('users/haozhima95/mapping_forest_functional_type/df_withenv_stem_with_fold_4class_20211208');
// print(ds.limit(2));
...
// var seedlist = [10,100,250,500,1000,1500,5000,9000,1200,2500];
...
// print(dfwithoneclass);
    // dfwithoneclass = ee.FeatureCollection(dfwithoneclass);
    // dfwithoneclass = dfwithoneclass.flatten();
// print(dfwithoneclass.limit(10));
...
// var fft4 = fft1.add(fft3);
//     fft4 = fft4.rename('d_pred')
...
//   image:fft_probability,
//   description:'fft_probability_mapping_stem_occurrence_recent_'+seedtouse+'_20221010',
...
// var allsample = comp.sampleRegions({
