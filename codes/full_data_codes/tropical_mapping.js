// This script is used for mapping tropical maps of current forest phenology.
...
var comp = ee.Image("users/haozhima95/Devin_environment_composite_20190218"),
    ...
    tropicalleaf = ee.FeatureCollection("users/haozhima95/forest_pheno/tropical_alldata_sampled_20191204");
...
var region1 = table.filterMetadata('BIOME','less_than',4);
var region2 = table.filterMetadata('BIOME','equals',7);
...
var mtry = [9,6,7,8,10,5,4,30,9,20];
print(mtry);

var leafpop = [2,2,2,2,2,2,2,2,3,2];
...
Export.image.toAsset({
  image:finalMap,
  description:'tropical_alldata_rf_'+st,
  assetId:'users/haozhima95/forest_pheno/tropical_alldata_rf_sppcor_'+st,
  crs:'EPSG:4326',
  region:unboundedGeo,
