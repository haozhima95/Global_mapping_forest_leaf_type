// This script is used for mapping approaches in tropical ecosystems
...
var mtry = [2,4,3,5,4,2,5,6,8,9];
print(mtry);

var leafpop = [2,2,2,2,3,3,3,3,3,3];
...
Export.image.toAsset({
  image:finalMap,
  description:'tropical_wdpa_rf_mg85_'+st,
  assetId:'users/haozhima95/forest_pheno/tropical_wdpa_rf_sppcor_mg85_'+st,
  crs:'EPSG:4326',
  region:unboundedGeo,
