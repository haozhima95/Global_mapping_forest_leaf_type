// This file is used for mapping approaches in temperate areas
...
//for(var j = 1; j<11; j++){
var j = 10;
var tabletorf = ee.FeatureCollection('users/haozhima95/forest_pheno/temperate_wdpa_'+j+'_sampled_20191129');
...
var mtry = [7,6,8,9,7,5,10,6,4,5];
print(mtry);

var leafpop = [4,4,5,4,3,3,5,3,3,4];
...
Export.image.toAsset({
  image:finalMap,
  description:'temperate_wdpa_rf_sppcor_mg85_'+st,
  assetId:'users/haozhima95/forest_pheno/temperate_wdpa_rf_sppcor_mg85_'+st,
  crs:'EPSG:4326',
  region:unboundedGeo,
