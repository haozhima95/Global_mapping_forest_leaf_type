...
var randomForestClassifier = ee.Classifier.smileCart({
	// numberOfTrees: 20,
...
Export.image.toAsset({
  image:alltogether,
  description:'fft_probability_summary_dbh_occurrence_recent_cart_20221010',
  assetId:'users/haozhima95/mapping_forest_functional_type/fft_probability_summary_dbh_occurrence_recent_cart_20221010',
  region: unboundedGeo,
 	crs: 'EPSG:4326',
...
Export.image.toCloudStorage({
  image:alltogether,
  description:'fft_probability_summary_mdbh_occurrence_recent_cart_20221010',
